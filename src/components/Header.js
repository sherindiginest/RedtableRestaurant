...
const Header = (props, context) => {
    ...
    const { backgroundColor = COLORS.white, transparent = false, lang, title, titleColor = COLORS.borderColor2, cartAction, cartButton = false, notificationButton = true, userData } = props
