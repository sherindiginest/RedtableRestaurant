...
const RenderMealItem = (props) => {
    ...
    return (
        <Pressable onPress={() => navigation.navigate("ChooseRestaurantsScreen", { item, type: "meal" })} style={{ height: WIDTH * 0.33, 
            borderRadius: WIDTH * 0.075, width: WIDTH * 0.3,
            //marginLeft: lang != "ar" ? WIDTH * 0.05 : lastelement ? WIDTH * 0.05 : 0, 
            //marginRight: lang == "ar" ? WIDTH * 0.05 : lastelement ? WIDTH * 0.05 : 0, 
        backgroundColor: COLORS.white, padding: WIDTH * 0.03, justifyContent: "space-between", alignItems: "center", elevation: 3 }}>
